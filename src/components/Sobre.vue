    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white rounded-lg p-6">
        ...
        <div>
          <p class="text-gray-400 leading-loose font-normal text-base">
            Nossa comunidade estudantil é um ambiente de aprendizado contínuo,
            onde cada aluno se apoia mutuamente, compartilha conhecimentos e
            cresce como profissional de TI. A colaboração é fundamental, pois
            eles trabalham em equipes multidisciplinares, compartilhando ideias,
            debatendo soluções e desenvolvendo sistemas robustos.
          </p>
        </div>
      </div>
      <div class="bg-white rounded-lg p-6">
        <div class="flex items-center space-x-6 mb-4">
          ...
          <div>
            <p class="text-xl text-gray-700 font-normal mb-1">
              Inspiração do Passado para o Futuro: Palestra com um Ex-Aluno de
              Sucesso
            </p>
        ...
        <div>
          <p class="text-gray-400 leading-loose font-normal text-base">
            Nossa fábrica de software é um ambiente onde sonhos se tornam
            realidade, e esse ex-aluno é a prova viva disso. Sua trajetória
            mostra como o conhecimento adquirido no ensino médio, combinado com
            uma educação superior em BSI, pode levar a conquistas notáveis em
            uma grande empresa como a Philips.
          </p>
        </div>
      </div>
      <div class="bg-white rounded-lg p-6">
      ...
      <div class="bg-white rounded-lg p-6">
        <div class="flex items-center space-x-6 mb-4">
          ...
          />
          <div>
            <p class="text-xl text-gray-700 font-normal mb-1">Oportunidade</p>
            <!-- <p class="text-base text-blue-600 font-normal">Graphic Designer</p> -->
          </div>
        </div>
        <div>
          <p class="text-gray-400 leading-loose font-normal text-base">
            Ao ingressar na Fábrica News, os alunos terão acesso a um ambiente
            de aprendizagem estimulante, mentoria de profissionais experientes e
            a oportunidade de trabalhar em projetos reais. Oferecemos uma
            plataforma para você aplicar seu conhecimento teórico e desenvolver
            habilidades práticas essenciais para o campo do desenvolvimento de
            software.
          </p>
        </div>
      </div>
